...
-- Many to Many (relasi antar dua tabel, dimana data di tabel pertama bisa memiliki banyak relasi di tabel ke dua, begitupun sebaliknya)
-- Relasi Many to Many memerlukan sebuah tabel untuk penghubung nya (tabel relasi), untuk menampung id dari kedua tabel yang berelasi
CREATE TABLE orders
(
